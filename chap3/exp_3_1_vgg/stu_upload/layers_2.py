            ...
            for idxc in range(self.channel_out):
                for idxh in range(height_out):
                    for idxw in range(width_out):
                        ...
                        input_temp = self.input_pad[idxn, :, idxh * self.stride:idxh * self.stride + self.kernel_size, idxw * self.stride:idxw * self.stride + self.kernel_size]
                        self.output[idxn, idxc, idxh, idxw] = np.sum(input_temp * weight_temp) + self.bias[idxc]#_______________________
        return self.output
