...
class MNIST_MLP(object):
    def __init__(self, batch_size=75, input_size=784, hidden1=32, hidden2=16, out_classes=10,
                 lr=0.01, max_epoch=10, print_iter=100):
    ...
    def build_model(self):  # 建立网络结构
        # TODO：建立三层神经网络结构
        print('Building multi-layer perception model...', self.hidden1, self.hidden2)
