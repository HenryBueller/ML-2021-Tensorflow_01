...
class MNIST_MLP(object):
    ...
    def build_model(self, batch_size=100, input_size=784, 
                    hidden1=300, hidden2=32, hidden3=16, out_classes=10,
        ...
        # fc1
        self.net.createMlpLayer('fc1', self.hidden1, self.input_quant_params[0])
        # __________________
        self.net.createReLuLayer('relu1')
        self.net.createMlpLayer('fc2', self.hidden2, self.input_quant_params[1])
        self.net.createReLuLayer('relu2')
        self.net.createMlpLayer('fc3', self.hidden3, self.input_quant_params[2])
        self.net.createReLuLayer('relu3')
        self.net.createMlpLayer('fc4', out_classes, self.input_quant_params[2])
        # self.net.createSoftmaxLayer('soft', 10)
...
def run_mnist():
    batch_size = 10000
    mlp = MNIST_MLP()
    mlp.build_model(batch_size=batch_size)
